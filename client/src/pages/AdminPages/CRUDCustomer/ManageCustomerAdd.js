            ...
            <div className={cx('member-wrapper')}>
                ...
                <Form style={{ margin: '2rem 15rem 2rem 15rem' }}>
                    ...
                    <div className={cx('button-field')}>
                        <MyButton className="btn btn-primary btn-lg" style={{ background: '#0c3b7c' }} to="/member">
                            {' '}
                            Huỷ{' '}
                        </MyButton>
                        <MyButton type="submit" className="btn btn-primary btn-lg" onClick={(e) => handleSubmit(e)}>
                            {' '}
                            Thêm{' '}
                        </MyButton>
                    </div>
